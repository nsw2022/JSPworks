...
<body>
	...
	<h3>set, out</h3>
	<c:set var="product1" value="삼성 Galaxy"/>
	<c:set var="product2" value="애플 iphone"/>
	<c:set var="intArray" value="${{1,2,3,4}}"/>
	<p>
		product1 : <c:out value="${product1}" />
	</p>
	<p>
		product2 : <c:out value="${product2}" />
	</p>
	...
	<h3>forTokens</h3>
	<!-- delims(델리미터): 구분기호 -->
	<c:forTokens var="cart" items="egg/coffe/water/milk" 
			delims="/" varStatus="i">
