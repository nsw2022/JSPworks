...
<% 
	...
	// 업로드 폴드 경로 \대신 /로 가능 
	String realFolder = "E:/NSW/green_project/JSPworks/Jspwork/src/main/webapp/upload";

	// MultipartRequest 객체 생성
	MultipartRequest multi = new MultipartRequest(request, realFolder,
				5*1024*1024, "utf-8", new DefaultFileRenamePolicy());

	// 요청 파라미터 name 속성 처리(Enumeration 객체 사용)
	...
	// 요청 파라미터 file 속성 처리(Enumeration 객체 사용)
	...
	while(files.hasMoreElements()){
		...
		out.println("원본 파일 이름" + originFile + "<br>");
